    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="#">Malformed Orders</a></li>
            </ul>
        </div><!--/.nav-collapse -->
    </div>
</div>
...
<div class="container">
    ...
    <h2>Malformed Orders</h2>

    <p class="lead">Below you will find the list of orders that appear to be incorrectly posted.</p>
    <p class="lead">Please select a request and try to fix data.</p>
